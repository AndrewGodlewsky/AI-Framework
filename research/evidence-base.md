...
5. **Where AI is *not* used is as informative as where it is.** Stack Overflow 2025, "don't plan to use AI for this": deployment/monitoring **75.8%**, project planning **69.2%**, commit and code review **58.7%**, predictive analytics **65.6%**. The refusal is concentrated exactly at the operations end of the lifecycle — the part of the spectrum that unsupervised autonomy would have to cross.
