...
- **Microsoft** revoked internal Claude Code licences, redirecting the **Experiences and Devices** division (Windows, M365, Outlook, Teams, Surface) to **GitHub Copilot CLI** by 30 June. The reported reason is **cost at enterprise scale, despite the tool's popularity** — People Matters, 25 May 2026: "Microsoft cancels Claude Code licences after engineers use it too much." Microsoft owns the replacement. `[SECONDARY]` across The Verge (14 May 2026), Windows Central (15 May 2026), Forbes (1 Jun 2026), Fortune (22 May 2026).
  ✅ **Body retrieved 2026-09-02 (ticket #12)** — the-decoder (15 May 2026, sourcing The Verge): the memo is from **Rajesh Jha, EVP Experiences and Devices**; deadline **30 June 2026** (Microsoft's fiscal year-end); the memo's **stated** reason is strategic consolidation (Copilot CLI "for tailoring the product to Microsoft's repositories and security needs", and "Claude Code was an important part of that learning"), with **cost the sources-say reason, not the stated one** — a correction to the headline framing. ⚠️ Still **no primary Microsoft statement**; the memo itself is unpublished.
- **Uber** capped AI spend at roughly **$1,500 per engineer per month** after exhausting its 2026 AI budget in four months. COO **Andrew Macdonald**, quoted: "It's very hard to draw a line between one of those stats and 'Okay, now we're actually producing 25% more useful consumer features'" — **a named company stating publicly that a measured 25% productivity increase did not translate into measurable shipped value.** `[SECONDARY]` — Business Insider (24 May 2026), Fortune (26 May 2026), TechCrunch (2 Jun 2026), analyticsindiamag (3 Jun 2026). ⚠️ The ~5,000-engineer, $500–2,000 per head and $1,200 two-hour-session figures come from low-tier aggregators and are unverified. This sits alongside the Uber entry in *The large middle*, where AI-related costs are reported up 6x since 2024.
  ✅ **Body retrieved 2026-09-02 (ticket #12)** — TechCrunch (2 Jun 2026, sourcing Bloomberg's scoop of the same date): the cap is **$1,500 per employee per month, per agentic coding tool** (Claude Code, Cursor — agentic tools only), **exceedable with permission, "the company says"** — i.e. Uber confirmed to press, but published no primary statement. The Macdonald quote and the blown-budget timeline corroborate as before.
- **Alibaba** imposed a company-wide Claude Code ban effective 10 Jul 2026, migrating to an in-house tool.
  ✅ **Reason now corroborated, 2026-09-02 (ticket #12)** — TechCrunch body retrieved (4 Jul 2026, sourcing Reuters); SCMP and CNBC (6 Jul 2026) quote the internal notice: *"As Claude Code was recently discovered to carry back-door risks, after comprehensive evaluation, Claude Code has now been added to a list of high-risk software with security vulnerabilities."* Context: developers had reverse-engineered Claude Code and found checks identifying Chinese users; **Anthropic's Thariq Shihipar acknowledged the experimental feature on the record** (anti-reseller/anti-distillation, being replaced with "stronger mitigations"). ⚠️ The notice itself is unpublished — the verbatim rests on press quoting it — and Alibaba is a **direct competitor** (staff directed to its own tool): the stated security reason and the competitive motive are not exclusive. Treat as `[SECONDARY, corroborated]`, never as an Alibaba primary.
...
- **Every named corporate restriction** (Microsoft's Claude Code licence revocation, Uber's spend cap, Alibaba's ban). Each is confirmed across multiple independent secondary outlets as an *event with a date*; **in no case was a primary company statement found.**
  ✅ **Partially upgraded 2026-09-02 (ticket #12): one article body per event is now retrieved** (the-decoder for Microsoft; TechCrunch for Uber and Alibaba — details inline above), so the detail is no longer headline-level. Still `[SECONDARY]` throughout: the Microsoft memo, Uber policy and Alibaba notice all remain unpublished, and each account traces to a single originating scoop (The Verge / Bloomberg / Reuters).
